...
export const stories: Stories[] = [
  ...
  },
  {
    ...
    story:
      "Once upon a time there was a little kitty with a old owner. The owner made an apple pie. The owner said to the kitty come here, I made some apple pie for you. The kitty loved apple pie. Then the kitty wanted to go outside. The owner said no kitty, it is too dangerous! But when the owner walked away, the kitty sneaked passed and went outside. When the kitty went outside, she felt lonely. She wanted to listened to her owner, she wanted to go home. But then a hungry fox came out! The fox said to the kitty, are you lost little kitty? And the kitty said, I am lost. And the fox said you look good to eat. But the kitty ate his eye, and his head, and his back and everything and the kitty found her owner.The End",
    createdDate: new Date().toLocaleDateString(),
    updatedDate: new Date().toLocaleDateString(),
    imageSrc:
